...
{
       0,    39,    39,    43,    45,    48,    56,    58,    62,    66,
      72,    74,    78,    80,    81,    82,    86,    91,    94,    97,
     100,   103
};
#endif
...
#line 39 "petit.y"
                                    { ast = (yyval.node) = newnode(Program, NULL);
                                      addchildren((yyval.node), (yyvsp[0].node_list)); }
#line 1325 "y.tab.c"
    break;
...
#line 43 "petit.y"
                                    { (yyval.node_list) = newlist();
                                      append((yyval.node_list), (yyvsp[0].node)); }
#line 1332 "y.tab.c"
    break;
...
#line 49 "petit.y"
                                    { (yyval.node) = newnode(Function, NULL);
                                      ...
                                      LOCATE(getchild((yyval.node), 0), (yylsp[-5]).first_line, (yylsp[-5]).first_column); }
#line 1348 "y.tab.c"
    break;
...
#line 62 "petit.y"
                                    { (yyval.node) = newnode(Parameter, NULL);
                                      ...
                                      LOCATE(getchild((yyval.node), 1), (yylsp[0]).first_line, (yylsp[0]).first_column); }
#line 1371 "y.tab.c"
    break;
